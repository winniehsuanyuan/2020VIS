...
const pcp_innerWidth = pcp_width - pcp_margin.left - pcp_margin.right;
const pcp_innerHeight = pcp_height - pcp_margin.top - pcp_margin.bottom;
            ...
            const AxisG = g.selectAll('axis').data(dimensions)
                ...
                .call(d3.drag() //reorder coors
                    ...
                    .on('drag', function(d) {
                        ...
                        dragging[d] = Math.min(pcp_innerWidth, Math.max(0, d3.event.x));
